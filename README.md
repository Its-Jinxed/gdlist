...
# obs
Download the .json in the obs folder, and import it into your own obs (Scene Collection > Import > Find the file). You can then selecet the scene from Scene Collection.
